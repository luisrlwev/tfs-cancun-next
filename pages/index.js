...
export default function FranquiciaCancun() {
  // Traducciones
  ...
  return (
    ...
    >
      <div className="portada-franquicias-cancun-inicio flex relative justify-center cursor-pointer" onClick={abrirModal}>
      ...
      <section className="pb-16">
        <div className="container mx-auto grid grid-cols-6 max-lg:grid-cols-2 gap-4">
          <div className="grid justify-items-center text-center">
            <Image src={'/img/cancun/beach-club.svg'} className="pb-3" width={68} height={68} alt="club de playa"/>
            <p>Beach Club</p>
          </div>
          <div className="grid justify-items-center text-center">
            <Image src={'/img/cancun/campo-golf.svg'} className="pb-3" width={68} height={68} alt="campo de golf"/>
            <p>{t('campo')}</p>
          </div>
          <div className="grid justify-items-center text-center">
            <Image src={'/img/cancun/bares.svg'} className="pb-3" width={68} height={68} alt="bares y restaurantes"/>
            <p>{t('bares')}</p>
          </div>
          <div className="grid justify-items-center text-center">
            <Image src={'/img/cancun/actividades.svg'} className="pb-3" width={68} height={68} alt="actividades"/>
            <p>{t('actividades')}</p>
          </div>
          <div className="grid justify-items-center text-center">
            <Image src={'/img/cancun/spa.svg'} className="pb-3" width={68} height={68} alt="spa"/>
            <p>Spa</p>
          </div>
          <div className="grid justify-items-center text-center">
            <Image src={'/img/cancun/ciclopistas.svg'} className="pb-3" width={68} height={68} alt="ciclopistas"/>
            <p>{t('ciclopistas')}</p>
          </div>
        </div>
      </section>
